    ...
    return (
        <div className="min-h-screen bg-[#FFFBE9]">
            <header className="flex items-center justify-between px-8 py-4 bg-[#E3CAA5]/30">
                {/* Logo */}
                <div className="font-extrabold text-xl tracking-wider text-[#AD8B73]">
                    ELEARNING
                </div>
                ...
                <div className="flex-1 mx-12 max-w-xl">
                    <input 
                        ...
                        className="w-full px-5 py-2 rounded-full border border-[#CEAB93] bg-white focus:outline-none focus:ring-2 focus:ring-[#AD8B73] placeholder-[#CEAB93] text-[#AD8B73]"
                    />
                </div>

                {/* Main Nav and Auth */}
                <div className="flex items-center gap-8">
                    <nav className="flex items-center gap-6 font-medium text-[#AD8B73]">
                    ...
                    <div className="ml-4">
                        {user.username ? (
                            <button 
                                ...
                                className="px-6 py-2 border-2 border-[#AD8B73] rounded hover:bg-[#AD8B73] hover:text-[#FFFBE9] transition-colors font-semibold text-[#AD8B73]"
                            >
                                Logout
                            </button>
                        ) : (
                            <a 
                                href="/login"
                                className="inline-block px-6 py-2 border-2 border-[#AD8B73] rounded hover:bg-[#AD8B73] hover:text-[#FFFBE9] transition-colors font-semibold text-[#AD8B73]"
                            >
                                Sign Up
                            </a>
                        )}
